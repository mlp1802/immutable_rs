        ...
        if let Fields::Named(fields) = &data.fields {
            fields
                ...
                .flat_map(|field| {
                    ...
                    let updater_name =
                        syn::Ident::new(&format!("update_{}", field_name), field_name.span());

                    let (setter, updater) = if let Some(inner_type) = extract_rc_inner_type(field_type) {
                        ...
                        if is_string_type(&inner_type) {
                            ...
                            (
                                ...
                                quote! {
                                    pub fn #updater_name(&self, f: impl FnOnce(&#inner_type) -> #inner_type) -> Self {
                                        Self {
                                            #field_name: std::rc::Rc::new(f(self.#field_name.as_ref())),
                                            ..self.clone()
                                        }
                                    }
                                }
                        ...
                        if is_string_type(&inner_type) {
                            ...
                            (
                                ...
                                quote! {
                                    pub fn #updater_name(&self, f: impl FnOnce(&#inner_type) -> #inner_type) -> Self {
                                        Self {
                                            #field_name: std::sync::Arc::new(f(self.#field_name.as_ref())),
                                            ..self.clone()
                                        }
                                    }
                                }
                        ...
                        (
                            ...
                            quote! {
                                pub fn #updater_name(&self, f: impl FnOnce(&#field_type) -> #field_type) -> Self {
                                    Self {
